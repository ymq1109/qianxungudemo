  ...
  <div id="Daily">
    <mq-table style="min-width:400px;" width="70%" title="日历管理">
      <template slot="mqtable-head">
        <el-form :model="dailyInfo" label-width="100px" class="demo-ruleForm">
          <el-form-item label="日期">
            <el-date-picker
              v-model="dailyInfo.daily"
              type="date"
...
export default {
  ...
  methods: {
    ...
    addLiked(item) {
      this.post(this.$apis.setDailyBackgroundLike, this.likeInfo).then(resp => {
